...
if(!((function (){var G__12634 = app_db;
if(G__12634){
...
return G__12634.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__12634.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__12634);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__12640){
...
return cljs.core.get_in.call(null,new_db,p1__12641_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__12642_SHARP_){
return cljs.core.get_in.call(null,db,p1__12642_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__12643__i < G__12643__a.length) {G__12643__a[G__12643__i] = arguments[G__12643__i + 2]; ++G__12643__i;}
  in_paths = new cljs.core.IndexedSeq(G__12643__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__12644){
var f = cljs.core.first(arglist__12644);
arglist__12644 = cljs.core.next(arglist__12644);
var out_path = cljs.core.first(arglist__12644);
var in_paths = cljs.core.rest(arglist__12644);
...
//# sourceMappingURL=middleware.js.map?rel=1440776937778