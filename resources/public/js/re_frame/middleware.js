...
if(!((function (){var G__12296 = app_db;
if(G__12296){
...
return G__12296.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__12296.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__12296);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__12302){
...
return cljs.core.get_in.call(null,new_db,p1__12303_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__12304_SHARP_){
return cljs.core.get_in.call(null,db,p1__12304_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__12305__i < G__12305__a.length) {G__12305__a[G__12305__i] = arguments[G__12305__i + 2]; ++G__12305__i;}
  in_paths = new cljs.core.IndexedSeq(G__12305__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__12306){
var f = cljs.core.first(arglist__12306);
arglist__12306 = cljs.core.next(arglist__12306);
var out_path = cljs.core.first(arglist__12306);
var in_paths = cljs.core.rest(arglist__12306);
...
//# sourceMappingURL=middleware.js.map?rel=1440297546247