...
}catch (e17572){if((e17572 instanceof Error)){
var e = e17572;
return null;
} else {
throw e17572;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__17573){
...
var build_id = cljs.core.get.call(null,map__17575__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__17575__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__17575__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__17575__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
});})(url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count))
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__17575,map__17575__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1440777373874