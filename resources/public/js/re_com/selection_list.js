...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__15427){
var map__15429 = p__15427;
var map__15429__$1 = ((cljs.core.seq_QMARK_.call(null,map__15429))?cljs.core.apply.call(null,cljs.core.hash_map,map__15429):map__15429);
var args = map__15429__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var multi_select_QMARK_ = cljs.core.get.call(null,map__15429__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__15424_SHARP_){
return item_renderer.call(null,p1__15424_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__15425_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__15425_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:((function (selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__15426_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__15426_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__15429,map__15429__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
)),choices);
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__15431){
...
var args = map__15432__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__15432,map__15432__$1,args){
return (function() { 
var G__15435__delegate = function (p__15433){
var map__15434 = p__15433;
var map__15434__$1 = ((cljs.core.seq_QMARK_.call(null,map__15434))?cljs.core.apply.call(null,cljs.core.hash_map,map__15434):map__15434);
var args__$1 = map__15434__$1;
...
while (G__15436__i < G__15436__a.length) {G__15436__a[G__15436__i] = arguments[G__15436__i + 0]; ++G__15436__i;}
  p__15433 = new cljs.core.IndexedSeq(G__15436__a,0);
} 
return G__15435__delegate.call(this,p__15433);};
G__15435.cljs$lang$maxFixedArity = 0;
G__15435.cljs$lang$applyTo = (function (arglist__15437){
var p__15433 = cljs.core.seq(arglist__15437);
return G__15435__delegate(p__15433);
});
G__15435.cljs$core$IFn$_invoke$arity$variadic = G__15435__delegate;
return G__15435;
})()
;
;})(map__15432,map__15432__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq15430){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15430));
});

//# sourceMappingURL=selection_list.js.map?rel=1440297549191