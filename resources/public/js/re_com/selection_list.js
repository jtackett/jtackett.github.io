...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__16260){
var map__16262 = p__16260;
var map__16262__$1 = ((cljs.core.seq_QMARK_.call(null,map__16262))?cljs.core.apply.call(null,cljs.core.hash_map,map__16262):map__16262);
var args = map__16262__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var multi_select_QMARK_ = cljs.core.get.call(null,map__16262__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__16257_SHARP_){
return item_renderer.call(null,p1__16257_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__16258_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__16258_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:((function (selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__16259_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__16259_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16262,map__16262__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
)),choices);
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__16264){
...
var args = map__16265__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__16265,map__16265__$1,args){
return (function() { 
var G__16268__delegate = function (p__16266){
var map__16267 = p__16266;
var map__16267__$1 = ((cljs.core.seq_QMARK_.call(null,map__16267))?cljs.core.apply.call(null,cljs.core.hash_map,map__16267):map__16267);
var args__$1 = map__16267__$1;
...
while (G__16269__i < G__16269__a.length) {G__16269__a[G__16269__i] = arguments[G__16269__i + 0]; ++G__16269__i;}
  p__16266 = new cljs.core.IndexedSeq(G__16269__a,0);
} 
return G__16268__delegate.call(this,p__16266);};
G__16268.cljs$lang$maxFixedArity = 0;
G__16268.cljs$lang$applyTo = (function (arglist__16270){
var p__16266 = cljs.core.seq(arglist__16270);
return G__16268__delegate(p__16266);
});
G__16268.cljs$core$IFn$_invoke$arity$variadic = G__16268__delegate;
return G__16268;
})()
;
;})(map__16265,map__16265__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq16263){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16263));
});

//# sourceMappingURL=selection_list.js.map?rel=1440777371835