...
var G__12425 = o;
(G__12425[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__12427__i < G__12427__a.length) {G__12427__a[G__12427__i] = arguments[G__12427__i + 0]; ++G__12427__i;}
  args = new cljs.core.IndexedSeq(G__12427__a,0);
} 
...
var old_12429 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_12429))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12429)].join(''):class$));
} else {
}
...
var G__12432 = jsprops;
(G__12432["defaultValue"] = value);

(G__12432["onChange"] = ((function (G__12432,v,value,on_change){
return (function (p1__12430_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12430_SHARP_);
});})(G__12432,v,value,on_change))
);
...
var vec__12434 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12434,(0),null);
var id = cljs.core.nth.call(null,vec__12434,(1),null);
var class$ = cljs.core.nth.call(null,vec__12434,(2),null);
...
var temp__4128__auto__ = (function (){var G__12436 = cljs.core.meta.call(null,v);
var G__12436__$1 = (((G__12436 == null))?null:reagent.impl.template.get_key.call(null,G__12436));
return G__12436__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12438_12439 = v;
var G__12438_12440__$1 = (((G__12438_12439 == null))?null:reagent.impl.template.key_from_vec.call(null,G__12438_12439));
var G__12438_12441__$2 = (((G__12438_12440__$1 == null))?null:(jsprops["key"] = G__12438_12440__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__12444 = cljs.core.meta.call(null,argv);
var G__12444__$1 = (((G__12444 == null))?null:reagent.impl.template.get_key.call(null,G__12444));
return G__12444__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__12445 = (((jsprops == null))?{}:jsprops);
(G__12445["key"] = key);
...
var n__5218__auto___12446 = a.length;
var i_12447 = (0);
while(true){
if((i_12447 < n__5218__auto___12446)){
(a[i_12447] = reagent.impl.template.as_element.call(null,(a[i_12447])));

var G__12448 = (i_12447 + (1));
i_12447 = G__12448;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__5218__auto___12449 = a.length;
var i_12450 = (0);
while(true){
if((i_12450 < n__5218__auto___12449)){
var val_12451 = (a[i_12450]);
if((cljs.core.vector_QMARK_.call(null,val_12451)) && ((reagent.impl.template.key_from_vec.call(null,val_12451) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12450] = reagent.impl.template.as_element.call(null,val_12451));

var G__12452 = (i_12450 + (1));
i_12450 = G__12452;
continue;
} else {
}
...
var G__12454 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12454) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12454){
...
//# sourceMappingURL=template.js.map?rel=1440776937176