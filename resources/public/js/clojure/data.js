...
return cljs.core.reduce.call(null,(function (result,p__12645){
var vec__12646 = p__12645;
var k = cljs.core.nth.call(null,vec__12646,(0),null);
var v = cljs.core.nth.call(null,vec__12646,(1),null);
...
var vec__12648 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12648,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12648,(1),null);
var ab = cljs.core.nth.call(null,vec__12648,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj12653 = {};
return obj12653;
})();
...
return (function (){var or__4333__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4969__auto__)]);
if(or__4333__auto__){
return or__4333__auto__;
} else {
var or__4333__auto____$1 = (clojure.data.equality_partition["_"]);
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj12655 = {};
return obj12655;
})();
...
if((function (){var and__4321__auto__ = a;
if(and__4321__auto__){
...
var x__4969__auto__ = (((a == null))?null:a);
return (function (){var or__4333__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4969__auto__)]);
if(or__4333__auto__){
return or__4333__auto__;
} else {
var or__4333__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__4333__auto____$1){
return or__4333__auto____$1;
} else {
...
if((function (){var G__12656 = x;
if(G__12656){
var bit__5007__auto__ = (G__12656.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__5007__auto__) || (G__12656.cljs$core$IMap$)){
return true;
} else {
if((!G__12656.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__12656);
} else {
return false;
}
}
...
if((function (){var G__12657 = x;
if(G__12657){
var bit__5007__auto__ = (G__12657.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__5007__auto__) || (G__12657.cljs$core$ISet$)){
return true;
} else {
if((!G__12657.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__12657);
} else {
return false;
}
}
...
if((function (){var G__12658 = x;
if(G__12658){
var bit__5007__auto__ = (G__12658.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__5007__auto__) || (G__12658.cljs$core$ISequential$)){
return true;
} else {
if((!G__12658.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__12658);
} else {
return false;
}
}
...
return (function (){var G__12659 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__12659) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1440774546399