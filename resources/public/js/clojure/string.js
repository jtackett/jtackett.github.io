...
while(true){
if(coll__$1){
var G__12397 = sb.append([cljs.core.str(cljs.core.first.call(null,coll__$1))].join(''));
var G__12398 = cljs.core.next.call(null,coll__$1);
sb = G__12397;
coll__$1 = G__12398;
continue;
} else {
...
var temp__4124__auto___12415 = cljs.core.get.call(null,cmap,ch);
if(cljs.core.truth_(temp__4124__auto___12415)){
var replacement_12416 = temp__4124__auto___12415;
buffer.append([cljs.core.str(replacement_12416)].join(''));
} else {
buffer.append(ch);
}

var G__12417 = (index + (1));
index = G__12417;
continue;
}
break;
...
//# sourceMappingURL=string.js.map?rel=1440774545372